    ...
    <div className="mb-4">
      ...
      {pendingDelete && (
        ...
        >
          ...
          >
            <p className="text-sm font-semibold text-dark text-center mb-1">Remove from log?</p>
            <p className="text-xs text-dark/40 font-body text-center mb-5 truncate px-2">
              {pendingDelete.name}
            </p>
            <button
              onClick={() => handleDelete(pendingDelete)}
              className="w-full py-3 rounded-2xl text-sm font-semibold text-white mb-2 transition-all active:scale-95"
